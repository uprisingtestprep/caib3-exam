/* CAIB3 Exam Simulator, Application Logic */

const ACCESS_CODE  = "CAIB39000";
const EXAM_SECONDS = 10800;
const PASSING_PCT  = 60;
const STORAGE_KEY  = "caib3_exam_state_v1";
...
const DOMAIN_LABELS = {"commercial_general_liability": "Commercial General Liability", "risk_management_and_exposure_identification": "Risk Management and Exposure Identification", "canadian_legal_system_and_tort_law": "Canadian Legal System and Tort Law", "marine_insurance": "Marine Insurance", "commercial_automobile_insurance": "Commercial Automobile Insurance", "aviation_insurance": "Aviation Insurance", "surety_bonds": "Surety Bonds", "umbrella_and_excess_liability": "Umbrella and Excess Liability", "specialty_commercial_products": "Specialty Commercial Products"};  // maps domain key -> human-readable label for display
